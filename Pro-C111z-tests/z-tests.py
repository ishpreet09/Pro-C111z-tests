...
df = pd.read_csv("D:/DATA DESKTOP/Notes Of Code/Python/Classwork/C-111z-tests/School2.csv")
...
df = pd.read_csv("D:/DATA DESKTOP/Notes Of Code/Python/Classwork/C-111z-tests/School_1_Sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("D:/DATA DESKTOP/Notes Of Code/Python/Classwork/C-111z-tests/School_2_Sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("D:/DATA DESKTOP/Notes Of Code/Python/Classwork/C-111z-tests/School_3_Sample.csv")
data = df["Math_score"].tolist()
